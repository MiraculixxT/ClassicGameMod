...
import de.miraculixx.cgames.ultralight.impl.renderer.ViewRenderer
import de.miraculixx.cgames.utils.ThreadLock
import de.miraculixx.cgames.utils.logger
import de.miraculixx.cgames.ultralight.impl.listener.ViewListener
import de.miraculixx.cgames.ultralight.impl.listener.ViewLoadListener
import de.miraculixx.cgames.ultralight.js.UltralightJsContext
...
open class ViewOverlay(val layer: RenderLayer, private val viewRenderer: ViewRenderer) {
    ...
    init {
        ...
        val width = window.width.toLong()
        val height = window.height.toLong()
...
//        context.events._unregisterEvents()
     ...
     * Render view
     */
    open fun render(matrices: Matrix3dStack) {
